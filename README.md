...
Blockchain Engineer with 3+ years of experience designing, developing, and deploying secure smart contracts and decentralized applications across multiple blockchain platforms. Proven expertise in Solidity and Rust development, DeFi protocol architecture, and building production-ready dApps. Strong background in blockchain security, having identified critical vulnerabilities in protocols managing $50M+ TVL. Skilled in optimizing gas costs, implementing cryptographic security measures, and collaborating with cross-functional teams to deliver scalable blockchain solutions.

---

## TECHNICAL SKILLS

**Blockchain Platforms:** Ethereum, Solana, Polygon, Arbitrum, Optimism, zkSync, Binance Smart Chain  
**Smart Contract Languages:** Solidity, Rust, Vyper  
**Development Frameworks:** Foundry, Hardhat, Truffle, Anchor, Remix  
**Web3 Libraries:** Web3.js, Ethers.js, Solana Web3.js  
**Security Tools:** Echidna, Slither, Mythril, Foundry Fuzzing  
**Languages:** JavaScript, TypeScript, Python, Node.js  
**Blockchain Concepts:** EVM Architecture, Consensus Algorithms, Cryptography, Token Standards (ERC-20, ERC-721, ERC-1155), Layer 2 Solutions  
**DeFi & dApps:** Staking Systems, Liquidity Pools, NFT Infrastructure, Token Economics, Cross-Chain Bridges  
**Tools & Practices:** Git, GitHub, CI/CD, Technical Documentation, Code Reviews, Gas Optimization  
**Integrations:** MetaMask, Phantom, WalletConnect, Chainlink Oracles, IPFS
...
Federal University of Oye Ekiti — Ekiti, Nigeria  
*Expected March 2026*
...
- Active contributor to blockchain security research and development communities
- Regular participant in blockchain hackathons and security competitions
- Continuous learning in emerging blockchain technologies, consensus mechanisms, and cryptographic protocols
- Open-source contributions to blockchain tooling and educational resources
